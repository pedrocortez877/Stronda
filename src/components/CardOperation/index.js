...
export function CardOperation(props) {
  ...
  return (
    <Card>
        ...
        <RowCard>
          {props.isCardReport ? (
            ...
            <>
              {props.isCardPurchased ? (
                <>
                  <ButtonSaleOrPurchase onClick={props.onClick}>
                    Cadastrar compra de produto
                  </ButtonSaleOrPurchase>
                  <ButtonSaleOrPurchase onClick={props.onClick}>
                ...
                <>
                  <ButtonSaleOrPurchase onClick={props.onClick}>
                    Cadastrar venda de produto
                  </ButtonSaleOrPurchase>
                  <ButtonSaleOrPurchase onClick={props.onClick}>
                    Cadastrar venda de serviço
                  </ButtonSaleOrPurchase>
                </>
              )}
            </>
      ...
      <FooterCard>
        {props.isCardReport ? (
          <Button onClick={props.onClick}>Ver relatório completo</Button>
        ) : (
          <></>
        )}
      </FooterCard>
